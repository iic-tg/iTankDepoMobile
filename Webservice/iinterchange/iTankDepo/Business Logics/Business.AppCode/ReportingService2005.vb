...
Namespace iInterchange.Framework.RS2005
...
Partial Public Class ReportingService2005
    ...
    '''<remarks/>
        Public Sub New(ByVal bv_service As String)
            MyBase.New()
            'Me.Url = "http://10.1.193.85/ReportServer/ReportService2005.asmx"
            Me.Url = bv_service
            'String.Concat(bv_server, "/ReportService2005.asmx")
        End Sub
    ...
    '''<remarks/>
    Public Function BeginListDependentItems(ByVal Item As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
        Return Me.BeginInvoke("ListDependentItems", New Object() {Item}, callback, asyncState)
    End Function
    ...
    '''<remarks/>
    Public Function BeginSetItemDataSources(ByVal Item As String, ByVal DataSources() As DataSource, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
        Return Me.BeginInvoke("SetItemDataSources", New Object() {Item, DataSources}, callback, asyncState)
    End Function
    ...
    '''<remarks/>
    Public Function BeginGetItemDataSources(ByVal Item As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
        Return Me.BeginInvoke("GetItemDataSources", New Object() {Item}, callback, asyncState)
    End Function
    ...
    '''<remarks/>
    Public Function BeginGetItemDataSourcePrompts(ByVal Item As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
        Return Me.BeginInvoke("GetItemDataSourcePrompts", New Object() {Item}, callback, asyncState)
    End Function
    ...
    '''<remarks/>
    Public Function BeginListTasks(ByVal SecurityScope As SecurityScopeEnum, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
    ...
    '''<remarks/>
    Public Function BeginListRoles(ByVal SecurityScope As SecurityScopeEnum, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
        Return Me.BeginInvoke("ListRoles", New Object() {SecurityScope}, callback, asyncState)
    End Function
    ...
    '''<remarks/>
    Public Function BeginCreateModel(ByVal Model As String, ByVal Parent As String, ByVal Definition() As Byte, ByVal Properties() As [Property], ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
        Return Me.BeginInvoke("CreateModel", New Object() {Model, Parent, Definition, Properties}, callback, asyncState)
    End Function
    
    '''<remarks/>
    Public Function EndCreateModel(ByVal asyncResult As System.IAsyncResult) As Warning()
        Dim results() As Object = Me.EndInvoke(asyncResult)
        Return CType(results(0),Warning())
    End Function
    ...
    '''<remarks/>
    Public Function BeginGetModelDefinition(ByVal Model As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
        Return Me.BeginInvoke("GetModelDefinition", New Object() {Model}, callback, asyncState)
    End Function
    
    '''<remarks/>
    Public Function EndGetModelDefinition(ByVal asyncResult As System.IAsyncResult) As Byte()
        Dim results() As Object = Me.EndInvoke(asyncResult)
        Return CType(results(0),Byte())
    End Function
    ...
    '''<remarks/>
    Public Function BeginSetModelDefinition(ByVal Model As String, ByVal Definition() As Byte, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
        Return Me.BeginInvoke("SetModelDefinition", New Object() {Model, Definition}, callback, asyncState)
    End Function
    
    '''<remarks/>
    Public Function EndSetModelDefinition(ByVal asyncResult As System.IAsyncResult) As Warning()
        Dim results() As Object = Me.EndInvoke(asyncResult)
        Return CType(results(0),Warning())
    End Function
    ...
    '''<remarks/>
    Public Function EndGenerateModel(ByVal asyncResult As System.IAsyncResult) As Warning()
        Dim results() As Object = Me.EndInvoke(asyncResult)
        Return CType(results(0),Warning())
    End Function
