...
#Region "Declaration Part.."
    ...
    Public Const _EDI_FILE_IDENTIFIER As String = "EDI_FILE_IDENTIFIER"
    Public Const _EDI_MOVEMENT As String = "EDI_MOVEMENT"
    Public Const _EDI_SEGMENT_DETAIL As String = "EDI_SEGMENT_DETAIL"
    Public Const _EDI_SEGMENT_HEADER As String = "EDI_SEGMENT_HEADER"
    Public Const _EDI_VERSION As String = "EDI_VERSION"

    Public Const _EDI As String = "EDI"
    Public Const _EDI_EMAIL_DETAIL As String = "EDI_EMAIL_DETAIL"
    Public Const _EDI_SETTINGS As String = "EDI_SETTINGS"
    Public Const _V_EDI_SETTINGS As String = "V_EDI_SETTINGS"
    'Data Columns..
    ...
    'Table Name: EDI_FILE_IDENTIFIER
    Public Const FL_IDNTFR_ID As String = "FL_IDNTFR_ID"
    Public Const FL_IDNTTY As String = "FL_IDNTTY"
    Public Const LNE_SG_INFO As String = "LNE_SG_INFO"
    Public Const FL_DSCRPTN_VC As String = "FL_DSCRPTN_VC"

    'Table Name: EDI_MOVEMENT
    Public Const MVMNT_ID As String = "MVMNT_ID"
    Public Const MVMNT_NAM As String = "MVMNT_NAM"
    Public Const MVMNT_DSCRPTN_VC As String = "MVMNT_DSCRPTN_VC"
    Public Const MVMNT_PRNT_ID As String = "MVMNT_PRNT_ID"

    'Table Name: EDI_SEGMENT_DETAIL
    Public Const SGMNT_DTL_ID As String = "SGMNT_DTL_ID"
    Public Const SGMNT_HDR_ID As String = "SGMNT_HDR_ID"
    Public Const SGMNT_DTL As String = "SGMNT_DTL"
    Public Const SGMNT_DTL_SZ As String = "SGMNT_DTL_SZ"
    Public Const SGMNT_DTL_ORDR As String = "SGMNT_DTL_ORDR"
    Public Const SGMNT_DTL_DLMTR As String = "SGMNT_DTL_DLMTR"
    Public Const SGMNT_DTL_PSTN As String = "SGMNT_DTL_PSTN"
    Public Const TRNS_CLMN As String = "TRNS_CLMN"
    Public Const SGMNT_DTL_DSCRPTN_VC As String = "SGMNT_DTL_DSCRPTN_VC"
    Public Const SGMNT_DTL_CMMNTS As String = "SGMNT_DTL_CMMNTS"
    Public Const MNDTRY As String = "MNDTRY"

    'Table Name: EDI_SEGMENT_HEADER
    Public Const SGMNT_HDR As String = "SGMNT_HDR"
    Public Const SGMNT_ORDR As String = "SGMNT_ORDR"
    Public Const SGMNT_SZ As String = "SGMNT_SZ"
    Public Const EDI_VRSN_ID As String = "EDI_VRSN_ID"
    Public Const LN_DLMTR As String = "LN_DLMTR"
    Public Const SGMNT_DLMTR As String = "SGMNT_DLMTR"
    Public Const SGMNT_PSTN As String = "SGMNT_PSTN"
    Public Const SGMNT_DSCRPTN_VC As String = "SGMNT_DSCRPTN_VC"
    Public Const SGMNT_PRNT As String = "SGMNT_PRNT"
    Public Const SGMNT_TYP As String = "SGMNT_TYP"

    'Table Name: EDI_VERSION
    Public Const EDI_VRSN As String = "EDI_VRSN"
    Public Const EDI_VRSN_PSTN As String = "EDI_VRSN_PSTN"
    Public Const EDI_VRSN_DSCRPTN_VC As String = "EDI_VRSN_DSCRPTN_VC"

    'Table Name: EDI
    Public Const EDI_ID As String = "EDI_ID"
    Public Const EDI_ACTVTY_NAM As String = "EDI_ACTVTY_NAM"
    Public Const GNRTD_DT_TM As String = "GNRTD_DT_TM"
    Public Const RSND_BIT As String = "RSND_BIT"
    Public Const ANC_FL_NM As String = "ANC_FL_NM"
    Public Const CDC_FL_NM As String = "CDC_FL_NM"
    Public Const CRTD_DT As String = "CRTD_DT"
    Public Const CSTMR_CD As String = "CSTMR_CD"
    Public Const FLE_FRMT As String = "FLE_FRMT"
    ...
    'Table Name: EDI_EMAIL_DETAIL
    Public Const ED_EML_ID As String = "ED_EML_ID"
    ...
    Public Const EDI_STTNGS_ID As String = "EDI_STTNGS_ID"
    Public Const CC_EML As String = "CC_EML"
    Public Const CHECKED As String = "CHECKED"
    Public Const FLE_FRMT_ID As String = "FLE_FRMT_ID"
    Public Const FLE_FRMT_CD As String = "FLE_FRMT_CD"
