Public Class GateOutRequestData
    ...
    Public Const RQST_APPRVL_CNGNE As String = "RQST_APPRVL_CNGNE"
    Public Const RQST_APPRVL_RMKRS As String = "RQST_APPRVL_RMKRS"
    Public Const GI_TRNSCTN_NO As String = "GI_TRNSCTN_NO"
    Public Const GTRQST_DT As String = "GTRQST_DT"
    Public Const GTRQST_BY As String = "GTRQST_BY"
    Public Const GTAPPRVL_DT As String = "GTAPPRVL_DT"
    Public Const GTAPPRVL_BY As String = "GTAPPRVL_BY"
