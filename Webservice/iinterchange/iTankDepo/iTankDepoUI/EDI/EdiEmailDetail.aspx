<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EdiEmailDetail.aspx.vb" Inherits="EDI_EdiEmailDetail" %>
...
<body onload="initPage();">
    ...
    <div id="divBulkEmailDetail">
        <table border="0" cellpadding="2" cellspacing="2" class="tblstd">
            <tr style="width: 100%;">
                <td colspan="5">
                    <iFg:iFlexGrid ID="ifgEdiEmailDetail" runat="server" AllowStaticHeader="True" DataKeyNames="EDI_ID"
