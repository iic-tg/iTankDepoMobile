<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ProductAttachmentDetail.aspx.vb" Inherits="Masters_ProductAttachmentDetail" %>
                ...
                <div id="divFlash" style="width: 90%; vertical-align: top; float: left; margin: 0px;">
                    <fieldset class="lbl" id="fldCostSummary" style="width: 550px; height: 360px;">
                        ...
                        <table>
                            <tr>
                                <td>
                                    <fUpload:FlashUpload ID="flashUpload" runat="server" UploadPage="ProductAttachmentDetail.aspx" 
