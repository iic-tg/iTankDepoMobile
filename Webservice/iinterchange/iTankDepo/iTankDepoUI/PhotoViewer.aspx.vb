        ...
        Try
            If Not Page.IsPostBack And Not Page.IsCallback Then
                If Not Request.QueryString("Estimation_No") Is Nothing Then
                    Dim dtPhotoUpload As DataTable
                    ...
                    dtPhotoUpload = objRepairEstimate.Pub_GetAttachmentByRepairEstimateNo(intDepotId, Request.QueryString("Estimation_No").ToString, Nothing, strUploadFilter).Tables(RepairEstimateData._ATTACHMENT)
                    'strUploadFilter
