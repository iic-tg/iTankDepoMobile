...
#Region "LoginReturn"
    ...
    Public Function LoginReturn(ByVal Username As String, ByVal Password As String) As Message
        Try
            ...
            '    Dim data As Byte() = md5Hash.ComputeHash(Encoding.UTF8.GetBytes("Admin@123"))
            ...
            If objCommon.ValidateLicense(CInt(objCommonData.GetDepotID())) Then
                ...
                Rsmsg.RL_ID = drUser(UserData.RL_ID)
                Rsmsg.Token = GenerateToken(Username)
...
#End Region
    ...
    Public Function GenerateToken(ByVal UserName As String) As String
