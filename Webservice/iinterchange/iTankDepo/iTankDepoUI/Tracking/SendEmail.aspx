<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SendEmail.aspx.vb" Inherits="Tracking_SendEmail" %>
    ...
    <div>
        <div>
            <table id="tblEmail">
                ...
                <tr>
                    <td>
                        <Inp:iLabel ID="lblCC" runat="server" CssClass="lbl">CC</Inp:iLabel>
                    </td>
                    <td>
                        :
                    </td>
                    <td>
                        <Inp:iTextBox ID="txtCC" runat="server" TabIndex="1" CssClass="txt" ToolTip="CC" HelpText="623,BULK_EMAIL_CC_EML" Height="" Width="450px" MaxLength="100" TextMode="SingleLine">
                            <Validator CustomValidateEmptyText="False" Operator="Equal" Type="String" IsRequired="False" RegErrorMessage="Invalid Email Id" RegexValidation="True" RegularExpression="^[\W]*([\w+\-.&%]+@[\w\-.]+\.[A-Za-z]{2,4}[\W]*,{1}[\W]*)*([\w+\-.&%]+@[\w\-.]+\.[A-Za-z]{2,4})[\W]*$" ReqErrorMessage="To Required" Validate="True" ValidationGroup="document" />
                        </Inp:iTextBox>
                    </td>
                    <td align="left">
                    </td>
