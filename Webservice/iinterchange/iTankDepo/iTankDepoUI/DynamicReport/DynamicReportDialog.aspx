<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DynamicReportDialog.aspx.vb" Inherits="DynamicReport_DynamicReportDialog" %>
...
<body class="backgr">
    ...
    <div id="divPrint" title="Print" runat="server" align="center" style="cursor:hand;position: absolute;
        margin-left: 705px; width: 26px; height: 23px; vertical-align: bottom; margin-top: 5px;
        padding-top: 2px">
        <img id="imgPrint" class="lbl" onclick="dPrint();" src="../Images/print.gif" onmouseover="document.getElementById('divPrint').className='overf';"
            onmouseout="document.getElementById('divPrint').className='overo';"" />
    </div>
    <div id="divEmail" title="Email" runat="server" align="center" style="cursor:hand;position: absolute;
        margin-left: 650px; width: 26px; height: 23px; vertical-align: bottom; margin-top: 5px;
        padding-top: 2px" class="overo">
            ...
            <td style="width: 800px">
                <div id="divTop1" runat="server" visible="false" style="overflow: auto; height: 80px;
                   ...
                   <input type="button" id="btnSetDefault" onclick="CreatePrintDocument();" class="btn"
                    ...
                    <div id="divEmail" onmouseout="mToolOut('imgbtnEmail');" onclick="dEmail();" onmouseover="mToolOver('imgbtnEmail');"
                        align="center" class="Reportsitem">
                        <img onmouseover="mToolOver('imgbtnEmail');" style="margin-top: 7px;" src="../Images/email.png" />
                        Email
                    </div>
                     <div id="divLoading" title="Loading" runat="server" align="center" style="position: absolute;
        margin-left: 740px; width: 26px; height: 23px; vertical-align: bottom; margin-top: 5px;
        padding-top: 2px">
       <input id="imgload" type="image" class="loadingimg" src="../Images/ajloader.gif" />
    </div>
                </div>
            </td>
            <td>
    ...
    <div>
        ...
        <iframe width="100%" name="ReportViewerFrame" height="750px" frameborder="0" 
            tabindex="-1" id="ReportViewerFrame" src="about:blank" marginwidth="0" marginheight="0" scrolling="auto">
        </iframe>
    </div>
