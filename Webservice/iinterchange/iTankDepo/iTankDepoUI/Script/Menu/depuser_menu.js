...
with (CCC = new menuname("Operations")) {
    ...
    aI("text=Owner Approval;showmenu=Owner Approval;status=Owner Approval");
    aI("text=Owner Repair Approval;showmenu=Owner Repair Approval;status=Owner Repair Approval");
    aI("text=Owner Approval;showmenu=Owner Approval;status=Owner Approval");
    aI(Activities[50]);
    aI("text=Repair Re Estimate;showmenu=Repair Re Estimate;status=Repair Re Estimate");
    aI(Activities[49]);
    aI(Activities[52]);
    aI(Activities[53]);
...
with (CCC = new menuname("Repair Re Estimate")) {
    style = menuStyle;
    overflow = "scroll";
    aI(Activities[45]);
    aI(Activities[46]);
...
with (CCC = new menuname("Owner Approval")) {
    style = menuStyle;
    overflow = "scroll";
    aI(Activities[70]);
    aI(Activities[71]);
