...
$.widget( "ui.accordion", {
	...
	options: {
		...
		heightStyle: "auto",
		icons: {
			activeHeader: "icon-caret-down icon-large",
			header: "icon-caret-right icon-large"
		},
...
(function ($) {
    var settings = {
        ...
        type: 'icon-info-sign', 			// notice, warning, error, success
    ...
    var methods = {
        ...
        showToast: function (options) {
            ...
            toastItemInner = $('<div></div>').hide().addClass('toast-item toast-type-' + localSettings.type).appendTo(toastWrapAll).html($('<p>').append('<span style="margin-left:50px"><B class="msgTitlePosition">' + localSettings.title + '</B></br>' + localSettings.text)).animate(localSettings.inEffect, localSettings.inEffectDuration).wrap(toastItemOuter);
            toastItemClose = $('<div title="Close"></div>').addClass('toast-item-close').prependTo(toastItemInner).html(localSettings.closeText+'<i class="icon-remove"></i>').click(function () { $().toastmessage('removeToast', toastItemInner, localSettings) });
            toastItemImage = $('<div valign="top"></div>').addClass('toast-item-image-'+ localSettings.type).html('<i class="' + localSettings.type + '"></i>').prependTo(toastItemInner);
        ...
        showNoticeToast: function (message) {
            var options = { text: message, type: 'icon-info-check', title: 'Information' };
            return $().toastmessage('showToast', options);
        },

        showSuccessToast: function (message) {
            var options = { text: message, type: 'icon-ok-sign',title:'Information' };
            return $().toastmessage('showToast', options);
        },

        showErrorToast: function (message) {
            var options = { text: message, type: 'icon-remove-sign',title:'Error' };
            return $().toastmessage('showToast', options);
        },

        showWarningToast: function (message) {
            var options = { text: message, type: 'icon-warning-sign',title:'Warning' };
            return $().toastmessage('showToast', options);
        },

        showImportantToast: function(message){
         var options = { text: message, type: 'icon-important-sign',title:'Important Message',sticky: true };
            return $().toastmessage('showToast', options);
        },
...
(function ($) {
    ...
    $.widget('ui.panel', {
        ...
        options: {
            ...
            //icons
            headerIconClpsd: 'icon-caret-left',
            headerIcon: 'icon-caret-right',
            slideRIconClpsd: 'icon-chevron-left',
            slideRIcon: 'icon-chevron-right',
            slideLIconClpsd: 'icon-chevron-right',
            slideLIcon: 'icon-chevron-left'
        },
...
; (function ($) {
    ...
    , calcNewCenterPaneDims = function () {
        ...
        //d.height =  document.documentElement.clientHeight - 154 ; // outerHeight
        d.height = ($(window).height())-110;
