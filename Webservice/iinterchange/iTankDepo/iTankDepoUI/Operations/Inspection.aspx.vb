...
Partial Class Operations_Inspection
    Inherits Pagebase
...
#Region "Page_Load"
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            chkAdditionalCleaningBit.Attributes.Add("onclick", "fnAdditionalCleaningCheck();")
        End If
    End Sub
#End Region
            ...
            Select Case e.CallbackType
                ...
                Case "CreateCleaning"
                    pvt_CreateCleaning(e.GetCallbackValue("CleaningID"), _
                                       ...
                                       e.GetCallbackValue("OriginalInspectedDate"), _
                                       e.GetCallbackValue("LastInspectedDate"), _
                                       e.GetCallbackValue("EquipmentStatus"), _
                                       e.GetCallbackValue("EquipmentStatusCD"), _
                                       e.GetCallbackValue("CleanedFor"), _
                                       e.GetCallbackValue("LocOfCleaning"), _
                                       e.GetCallbackValue("EquipmentCleaningStatus1"), _
                                       e.GetCallbackValue("EquipmentCleaningStatus1CD"), _
                                       e.GetCallbackValue("EquipmentCleaningStatus2"), _
                                       e.GetCallbackValue("EquipmentCleaningStatus2CD"), _
                                       e.GetCallbackValue("EquipmentCondition"), _
                                       e.GetCallbackValue("EquipmentConditionCD"), _
                                       e.GetCallbackValue("ValveandFittingCondition"), _
                                       e.GetCallbackValue("ValveandFittingConditionCD"), _
                                       e.GetCallbackValue("InvoicingTo"), _
                                       e.GetCallbackValue("InvoicingToCD"), _
                                       e.GetCallbackValue("ManLidSealNo"), _
                                       e.GetCallbackValue("TopSealNo"), _
                                       e.GetCallbackValue("BottomSealNo"), _
                                       e.GetCallbackValue("CustomerReferenceNo"), _
                                       ...
                                       e.GetCallbackValue("AdditionalCleaningStatus"))
                Case "UpdateCleaning"
                    pvt_UpdateCleaning(e.GetCallbackValue("CleaningID"), _
                                       ...
                                       CInt(e.GetCallbackValue("ActivityId")), _
                                       CBool(e.GetCallbackValue("blnAdditionalCleaningBit")), _
                                       e.GetCallbackValue("NextAcitivity"))
                ...
                Case "CustomerEDIValidation"
                    pvt_CustomerEDIValidation(e.GetCallbackValue("CustomerCode"), e.GetCallbackValue("DepotID"))
            End Select
...
#Region "pvt_CustomerEDIValidation"

    Private Sub pvt_CustomerEDIValidation(ByVal bv_strCustomerCode As String, ByVal bv_strDPT_ID As String)
        Try
            Dim intEDICount As Int32 = 0

            Dim objCleaning As New Cleaning
            intEDICount = objCleaning.pub_CustomerEDIValidation(bv_strCustomerCode, bv_strDPT_ID)

            If intEDICount > 0 Then
...
#Region "pvt_CreateCleaning"
    Private Sub pvt_CreateCleaning(ByVal bv_strCleaningId As String, _
                                   ...
                                   ByVal bv_strAdditionalCleaning_Status As String)
        Try
            Dim objCommon As New CommonData
            ...
            End If
            'bv_strCrtfct_No
            pub_SetCallbackReturnValue("CleaningCertificate", bv_strCrtfct_No)
            'Status value
            If bv_blnAdditionalCleaningFlag = False Then
                pub_SetCallbackReturnValue("Status", "6")
            Else
                Dim intEquipment_StatusId As Int64 = 3
                If bv_strAdditionalCleaning_Status.ToLower() = "repair" Then
                    intEquipment_StatusId = 7
                End If
                pub_SetCallbackReturnValue("Status", CStr(intEquipment_StatusId))
            End If
            pub_SetCallbackReturnValue("ID", CStr(lngCreated))
            pub_SetCallbackReturnValue("Message", String.Concat("Inspection : ", " ", "Equipment ", bv_strEquipmentNo, strMSGINSERT))
            pub_SetCallbackStatus(True)
        Catch ex As Exception
            pub_SetCallbackStatus(False)
            iErrorHandler.pub_WriteErrorLog(Me.GetType.Name, Reflection. _
...
#Region "pvt_UpdateCleaning"
    Private Sub pvt_UpdateCleaning(ByVal bv_strCleaningID As String, _
                                   ...
                                   ByVal bv_intActivityId As Integer, _
                                   ByVal bv_blnAdditionalCleaningFlag As Boolean, _
                                   ByVal bv_NextAcitivity As String)
        Try
            Dim objCommon As New CommonData
            Dim intDPT_ID As Integer = CommonWeb.iInt(objCommon.GetDepotID())
            Dim strActivitySubmit As String = String.Empty
            ...
            ''
            dsCleaning = CType(RetrieveData(CLEANING), CleaningDataSet)
            objCleaning.ModifyCleaning_Inspection(CommonWeb.iLng(bv_strCleaningID), _
                                       bv_strEquipmentNo, _
                                       bv_strCrtfct_No, _
                                       bv_strChemicalName, _
            ...
            pub_SetCallbackReturnValue("Message", String.Concat("Inspection : ", " ", "Equipment ", bv_strEquipmentNo, strMSGUPDATE))
            pub_SetCallbackStatus(True)
        Catch ex As Exception
            pub_SetCallbackStatus(False)
            iErrorHandler.pub_WriteErrorLog(Me.GetType.Name, Reflection. _
...
#Region "pvt_GetData"
    Private Sub pvt_GetData(ByVal bv_strMode As String)
        Try
            ...
            Dim str073_KeyValue As String
            Dim bln073_KeyExists As Boolean
            ...
            If bv_strMode = MODE_NEW Then
                ...
                'End If
                str073_KeyValue = objCommon.GetConfigSetting("073", bln073_KeyExists)
                If bln073_KeyExists AndAlso str073_KeyValue.ToLower = "true" Then
                    If (PageSubmitPane.pub_GetPageAttribute(CleaningData.SLB_RT_BT)) Is Nothing Then
                    Else
                        If CBool(PageSubmitPane.pub_GetPageAttribute(CleaningData.SLB_RT_BT)) Then
                            sbCleaning.Append(CommonWeb.GetHiddenTextValuesJSO(hdnSlabRateFlag, "True"))
                        ElseIf PageSubmitPane.pub_GetPageAttribute(CleaningData.CLNNG_RT) Is Nothing Then
                            sbCleaning.Append(CommonWeb.GetTextValuesJSO(txtCleaningRate, ""))
                        Else
                ...
                sbCleaning.Append(CommonWeb.GetLookupValuesJSO(lkpStatus, 6, "INS"))
                ...
                If PageSubmitPane.pub_GetPageAttribute(CleaningData.ORGNL_CLNNG_DT) Is Nothing Then
                    sbCleaning.Append(CommonWeb.GetTextDateValuesJSO(datOriginalCleaningDate, ""))
                Else
                    sbCleaning.Append(CommonWeb.GetTextDateValuesJSO(datOriginalCleaningDate, CDate(PageSubmitPane.pub_GetPageAttribute(CleaningData.ORGNL_CLNNG_DT)).ToString("dd-MMM-yyyy").ToUpper()))
                End If

                'sbCleaning.Append(CommonWeb.GetTextDateValuesJSO(datOriginalCleaningDate, datGetDateTime.ToString("dd-MMM-yyyy").ToUpper))

                If PageSubmitPane.pub_GetPageAttribute(CleaningData.LST_CLNNG_DT) Is Nothing Then
                    sbCleaning.Append(CommonWeb.GetTextDateValuesJSO(datLastCleaningDate, ""))
                Else
                    sbCleaning.Append(CommonWeb.GetTextDateValuesJSO(datLastCleaningDate, CDate(PageSubmitPane.pub_GetPageAttribute(CleaningData.LST_CLNNG_DT)).ToString("dd-MMM-yyyy").ToUpper()))
                End If
                ...
                sbCleaning.Append(CommonWeb.GetTextValuesJSO(txtLocOfCleaning, (objCommon.GetLocationOfCleaning())))
                ...
                If Not (PageSubmitPane.pub_GetPageAttribute(CleaningData.ADDTNL_CLNNG_BT) Is Nothing AndAlso PageSubmitPane.pub_GetPageAttribute(CleaningData.ADDTNL_CLNNG_FLG) Is Nothing) Then
                    ...
                    Else
                        ...
                        If Not PageSubmitPane.pub_GetPageAttribute(CleaningData.ORGNL_INSPCTD_DT) Is Nothing Then
                        ...
                        Else
                            sbCleaning.Append(CommonWeb.GetTextValuesJSO(datOriginalInspectedDate, ""))
                        End If
            ...
            ElseIf bv_strMode = MODE_EDIT Then
                ...
                If PageSubmitPane.pub_GetPageAttribute(CleaningData.INVCNG_PRTY_CD) <> "NULLABLE" And PageSubmitPane.pub_GetPageAttribute(CleaningData.INVCNG_PRTY_CD) <> "" Then
                    If objCommon.GetMultiLocationSupportConfig().ToLower = "true" Then
                        dtParty = objCleaning.GerCurrencyCode(PageSubmitPane.pub_GetPageAttribute(CleaningData.INVCNG_PRTY_ID), objCommon.GetHeadQuarterID()).Tables(CleaningData._INVOICING_PARTY)
                    Else
            ...
            sbCleaning.Append(CommonWeb.GetLookupValuesJSO(lkpAddtnCleaning, "", ""))
            CacheData(CLEANING, dsCleaning)
            ...
            iErrorHandler.pub_WriteErrorLog(Me.GetType.Name, Reflection.MethodBase.GetCurrentMethod.Name, _
                                           ...
                                           "  IS_CHNG_OF_STTS", PageSubmitPane.pub_GetPageAttribute(CleaningData.IS_CHNG_OF_STTS)))
        Catch ex As Exception
            pub_SetCallbackStatus(False)
            iErrorHandler.pub_WriteErrorLog(Me.GetType.Name, Reflection. _
                                             MethodBase.GetCurrentMethod.Name, ex)
...
#Region "PreRender"
    Protected Sub Page_PreRender1(sender As Object, e As System.EventArgs) Handles Me.PreRender
        Try
            ...
            CommonWeb.IncludeScript("Script/Operations/Inspection.js", MyBase.Page)
...
#Region "pvt_ValidateOriginalInspectedDate"
    Private Sub pvt_ValidateOriginalInspectedDate(ByVal bv_strEquipmentNo As String, ByVal bv_strEventDate As String, ByVal bv_strCleaningDate As String)
        Try
            ...
            If blnDateValid = True Then
                pub_SetCallbackReturnValue("Error", String.Concat("Original Inspection Date should be greater than or equal to Latest Cleaning Date (", Originaldate.ToString("dd-MMM-yyyy"), ")"))
            End If
            pub_SetCallbackStatus(True)
            'pub_SetCallbackReturnValue("Error", "")
        Catch ex As Exception
