<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RepairInvoiceUpdateReason.aspx.vb" Inherits="Operations_RepairInvoiceUpdateReason" %>
    ...
    <table align="center">
        ...
        <tr align="center" valign="middle">
            <td align="center" valign="middle">
                <a href="#" id="btnSave" onclick="updateReason(); return false;" class="btn btn-small btn-success" runat="server" style="font-weight: bold; vertical-align: middle"><i class="icon-save"></i>&nbsp;Save</a>
            </td>
        </tr>
    </table>
    </div>
