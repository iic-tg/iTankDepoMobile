<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EquipmentInformationDetail.aspx.vb" Inherits="Operations_EquipmentInformationDetail" %>
...
<body onload="initPage();">
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <%--UIG Fix--%>
            <td style="width: 27%; float: left; vertical-align: top;">
    ...
    <asp:HiddenField ID="hdnEquipmentInformationId" runat="server" />
    </div>
    </form>
</body>
</html>
