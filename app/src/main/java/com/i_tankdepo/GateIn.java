...
public class GateIn extends CommonActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private TextView tv_type,tv_equip_no,tv_cargo,tv_cust_name,tv_toolbarTitle, tv_add, tv_search_options,no_data,list_noData;
    ...
    ArrayList<Product> products_Cust ;
    ...
    private String CNSGN_LCTN,CNSGN_NAM;
    @Override
    ...
    public void onClick(View view) {
        switch (view.getId())
        {
            case R.id.iv_changeOfStatus:
                ...
                break;
            case R.id.add:
                startActivity(new Intent(getApplicationContext(),Ocr_Activity.class));
                    ...
                    if (jsonarray.length() < 1) {
                        ...
                        for (int i = 0; i < jsonarray.length(); i++) {
                            ...
                            for(int j=0;j<attachmentjson.length();j++)
                            {
                                ...
                                //Added by Anantha krishnan
                                pending_bean.setConsigneeName(jsonObject.getString("CNSGN_NAM"));
                                pending_bean.setConsigneeLocation(jsonObject.getString("CNSGN_LCTN"));
    ...
    public class UserListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (list.size() < 1){
                ...
                holder.time.setText(userListBean.getPreviousCargo());
...
/*
                ...
                holder.whole.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        //Added by Anantha krishnan
                        CNSGN_NAM = list.get(position).getConsigneeName();
                        CNSGN_LCTN = list.get(position).getConsigneeLocation();
        ...
        protected void onPostExecute (Void aVoid){
            ...
            if(jsonrootObject!=null)
            {
                if(Lock_return_Message.equalsIgnoreCase("Success"))
                {
                    ...
                    //Added by Anantha krishnan
                    GlobalConstants.CNSGN_NAM = CNSGN_NAM;
                    GlobalConstants.CNSGN_LCTN = CNSGN_LCTN;
...
//                        longToast("This takes longer than usual time. Connection Timeout !");
                       ...
                       /* businessAccessDetailsBeanArrayList = new ArrayList<>();
                        ...
                        products_Cust = new ArrayList<Product>();
                        ...
                        for (int i = 0; i < jsonarray.length(); i++) {
                            ...
                            products_Cust.add(new Product(jsonObject.getString("Name"),false));
        ...
        protected void onPostExecute (Void aVoid) {
            ...
            if (dropdown_customer_list != null) {
                ...
                boxAdapter = new ListAdapter(GateIn.this, products_Cust);
                searchlist.setAdapter(boxAdapter);
