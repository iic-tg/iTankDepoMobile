...
* */
public class AddRepair_Approvel_Details extends CommonActivity implements View.OnClickListener {
    ...
    private String set_invoice_name;
        ...
        }else
        {
            ...
            if(!add_detail_jsonobject.equalsIgnoreCase("detail_json") || !add_detail_jsonobject.equals(null))
            {
                try {
                    ...
                    set_invoice_name=jsonrootObject.getString("invoice_name");
                    GlobalConstants.invoice_PartyCD=set_invoice_name;
...
*/
    ...
    public class Create_GateIn_moreInfo_list_details extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(AddRepair_Approvel_Details.this);
...
//                        longToast("This takes longer than usual time. Connection Timeout !");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (dropdown_customer_list != null) {
                ...
                if (Invoice_party <= 0) {
                    SpinnerCustomAdapter CustomerAdapter = new SpinnerCustomAdapter(AddRepair_Approvel_Details.this, R.layout.spinner_text, CustomerDropdown_Invoice_ArrayList);
                    CustomerAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    ...
                    for (int i = 0; i < CustomerDropdown_Invoice_ArrayList.size(); i++) {
                        try {
                            if (GlobalConstants.invoice_PartyCD.equals(CustomerDropdown_Invoice_ArrayList.get(i).getName())) {
