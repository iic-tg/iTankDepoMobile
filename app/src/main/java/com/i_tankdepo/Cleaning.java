...
* */
public class Cleaning extends CommonActivity implements NavigationView.OnNavigationItemSelectedListener {
...
//        searchView2.addTextChangedListener(mTextEditorWatcher);
    ...
    public class Get_Cleaning_details extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            HttpPost httpPost = new HttpPost(ConstantValues.baseURLCleaningPreadvice);
...
//                        longToast("This takes longer than usual time. Connection Timeout !");
                        ...
                        for (int i = 0; i < jsonarray.length(); i++) {
                            ...
                            cleaning_bean.setBv_blnSlabRateFlag(jsonObject.getString("bv_blnSlabRateFlag"));
...
/*
                ...
                holder.whole.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        GlobalConstants.status = "ACN";
                        GlobalConstants.equip_status = "ACN";
                        GlobalConstants.equip_status_id = "5";
//                        cleaning_bean.setChemicalName(jsonObject.getString("ChemicalName"));
                        GlobalConstants.ChemicalName =  list.get(position).getChemicalName();
                        GlobalConstants.bv_blnSlabRateFlag =  list.get(position).getBv_blnSlabRateFlag();
