...
* */
public class Repair_Completions_wizard_MySubmit extends CommonActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.add_details:
                ...
                startActivity(new Intent(getApplicationContext(), AddRepair_Completion_Details_MySubmit.class));
...
//                        GlobalConstants.customer_Id=customer_Id;
                GlobalConstants.Line_item_Json = Line_item_Json;
                startActivity(new Intent(getApplicationContext(), Attach_Repair_Completion_MySubmit.class));
    ...
    public class Tarif_Group_details extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(Repair_Completions_wizard_MySubmit.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if(jsonarray!=null) {
                ...
                sp_tarif_code.setAdapter(CustomerAdapter);*/
                    customAdapter = new SpinnerCustomAdapter(Repair_Completions_wizard_MySubmit.this, R.layout.spinner_text, Tariff_code_ArrayList);
...
//            progressDialog.dismiss();
            ...
            if (jsonarray != null) {
                adapter = new UserListAdapter(Repair_Completions_wizard_MySubmit.this, R.layout.line_item_row_survey, lineitem_arraylist);
...
//                        longToast("This takes longer than usual time. Connection Timeout !");
                        ...
                        multiple_encodeArray =new ArrayList<Image_Bean>();
                        for (int j = 0; j < jsonarray.length(); j++) {
                            ...
                            if(GlobalConstants.equipment_no.equalsIgnoreCase(jsonObject.getString("EquipmentNo")))
                            {
                                ...
                                for (int i = 0; i < LineItems_Json.length(); i++) {
                                    ...
                                    multiple_encodeArray.add(image_bean);
                                    // totel_amount=totel_amount+Integer.parseInt(jsonObject_line.getString("TotelCost"));
            ...
            if(encodeArray!=null)
            {
                try {
                    if(GlobalConstants.from.equalsIgnoreCase("MySubmitRepair")||
                            GlobalConstants.from.equalsIgnoreCase("Repairpending")) {
                        notification_text.setText(String.valueOf(multiple_encodeArray.size()));
