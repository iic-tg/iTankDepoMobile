...
public class AddRepair_Estimation_Details extends CommonActivity implements View.OnClickListener {
                ...
                if (Invoice_party > 0) {
                   /* if (ed_invoicing_party.getText().toString().equals("")) {
                    ...
                    try {
                        ...
                        obiect.put("InvoiceParty_name", GlobalConstants.invoice_PartyCD);
                        obiect.put("get_sp_repairtype_code", get_sp_repairtype_code);
                        obiect.put("get_repair_type", get_repair_type);
...
//                    }
    ...
    public class Create_GateIn_moreInfo_list_details extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(AddRepair_Estimation_Details.this);
...
*/
                SpinnerCustomAdapter CustomerAdapter = new SpinnerCustomAdapter(AddRepair_Estimation_Details.this, R.layout.spinner_text, CustomerDropdown_Invoice_ArrayList);
