...
public class RepairCompletionMySubmit extends CommonActivity implements NavigationView.OnNavigationItemSelectedListener {
...
//        searchView2.addTextChangedListener(mTextEditorWatcher);
    ...
    public class Get_RepairCompletion_MySubmit_Details extends AsyncTask<Void, Void, Void> {
