...
//                Iv_manhour_cost.setText(String.valueOf(Iv_man_hour_cost) + "0");
                Iv_metrial_cost.setText(String.valueOf(Iv_metrialCost).replace("E", "").replace("-", ""));
        ...
        tv_cust_crr.setText(String.valueOf(sp.getString(SP_ORG_TC_AMT,"original_tc_amount")).replace("-", "") + ".00" + " " + GlobalConstants.currency);
        tv_depo_crr.setText(String.valueOf(total).replace("-", "") + ".00" + " " + GlobalConstants.currency);
                        ...
                        for (int j = 0; j < jsonarray.length(); j++) {
                            ...
                            if (GlobalConstants.equipment_no.equalsIgnoreCase(jsonObject.getString("EquipmentNo"))) {
                                ...
                                for (int i = 0; i < LineItems_Json.length(); i++) {
                                    ...
                                    OriginalEstimateAmount = jsonObject_line.getString("OriginalEstimateAmount");
