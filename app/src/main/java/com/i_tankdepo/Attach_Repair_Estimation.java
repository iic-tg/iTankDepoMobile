...
* */
public class Attach_Repair_Estimation extends CommonActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.im_capture:
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Attach_Repair_Estimation.this);
                builder.setTitle("Add Photo!");
                builder.setItems(items, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int item) {
                        boolean result= Utility.checkPermission(Attach_Repair_Estimation.this, isCamPermission);
                        ...
                        if (items[item].equals("Take Photo")) {
                            ...
                            if(result)
                                startActivityForResult(new Intent(Attach_Repair_Estimation.this, CustomGallery_Activity.class), CustomGallerySelectId);
            ...
            case R.id.Line_iteam:
                ...
                finish();
                startActivity(new Intent(getApplicationContext(),Repair_Estimation_wizard.class));
...
*/
    ...
    public class Get_Repair_MySubmit_details extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(Attach_Repair_Estimation.this);
